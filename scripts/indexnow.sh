...
BASE_URL="https://${HOST}"
BING_API_KEY="96c8b1328f5c40328576f05f7a3c9028"
BING_URL_TO_KEY_FILE="${BASE_URL}/${BING_API_KEY}.txt"
BING_URL="https://www.bing.com"

BLOG_DIR=../../../content/post/; # Location of /content/blog/ folder relative to tmp working dir
